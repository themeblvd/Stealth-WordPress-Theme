        ...
        foreach($news as $post) {
            ...
            <div class="entry">
                    <?php if ( has_post_thumbnail() ) : ?>
                            <?php the_post_thumbnail('micro'); ?>
                    <?php endif; ?>
                    <span class="title">
                            <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a>
                            <?php if($meta == 'on') : ?>
                            <span class="meta">
                                    <?php print __('Posted on '); the_time('F j, Y'); ?>
                            </span>
                            <?php endif; ?>
                    </span>
                    <div class="clear"></div>
...
?>			
        ...
        <p>
                ...
                <input class="widefat" style="width: 95%" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" />
        </p>

        <!-- # of Posts: Text Input -->
        <p>
                <label for="<?php echo $this->get_field_id( 'num' ); ?>">Number of posts to show: </label>
                <input id="<?php echo $this->get_field_id( 'num' ); ?>" name="<?php echo $this->get_field_name( 'num' ); ?>" value="<?php echo $instance['num']; ?>" class="widefat" style="width:40px;" />
        </p>
        ...
        <p>
                ...
                <input type="checkbox" id="<?php echo $this->get_field_id( 'meta' ); ?>" name="<?php echo $this->get_field_name( 'meta' ); ?>" <?php if($instance['meta'] == 'on') { echo "checked"; } ?> style="width:40px;" class="widefat" />
        </p>
